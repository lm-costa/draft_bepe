...
Before going plot the data, first we are gonna make a subset for some variables
...
Also we need another transformations to a correlation plot for all the Fluoresce spectra
